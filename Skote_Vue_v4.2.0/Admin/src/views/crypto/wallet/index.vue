...
import { OveviewChart, activitiesData, items, walletData } from "./data";
/**
 * Wallets component
 */
export default {
  ...
  data() {
    return {
      OveviewChart, activitiesData, items, walletData,
      totalRows: 1,
      currentPage: 1,
      perPage: 10,
      pageOptions: [
      ...
      <BCol xl="8">
        ...
        <BCard no-body>
          <BCardBody>
            ...
            <div>
              <apexchart class="apex-charts" height="228" type="line" dir="ltr" :series="OveviewChart.series"
