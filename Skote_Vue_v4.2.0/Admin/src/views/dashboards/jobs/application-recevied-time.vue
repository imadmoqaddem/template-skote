...
<template>
    <BCard no-body>
        <BCardBody>
            <div class="d-flex">
                <BCardTitle>Applications Received Time</BCardTitle>
            ...
            <apexchart class="apex-charts" type="line" dir="ltr" height="378" :series="series" :options="chartOptions">
            </apexchart>
        </BCardBody>
    </BCard>
</template>
