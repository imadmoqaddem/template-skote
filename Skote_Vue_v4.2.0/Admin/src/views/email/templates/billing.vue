...
<template>
    <Layout>
        <PageHeader title="Billing Email" pageTitle="Email Template" />
                            ...
                            <td class="container" width="600"
                                ...
                                <div class="content"
                                    ...
                                    <table class="main" width="100%" cellpadding="0" cellspacing="0"
                                        ...
                                        <tbody> <!-- Wrap <tr> elements in <tbody> -->
                                            <tr>
                                                <td class="content-wrap aligncenter"
                                                    ...
                                                    <table width="100%" cellpadding="0" cellspacing="0"
                                                                            ...
                                                                            <tr
                                                                                ...
                                                                                <td style="font-family: 'Helvetica Neue',Helvetica,Arial,sans-serif; box-sizing: border-box; font-size: 14px; vertical-align: top; margin: 0; padding: 5px 0;"
                                                                                    ...
                                                                                    <table class="invoice-items"
                                                                                        ...
                                                                                        <!-- Closing <tbody> for invoice items -->
                                                                                    </table>
                                                                                </td>
                                                                            </tr>
                                                                        </tbody> <!-- Closing <tbody> for invoice -->
                                                                    </table>
                                                                </td>
                                                            </tr>
                                                        ...
                                                        </tbody> <!-- Closing <tbody> for content block -->
                                                    </table>
                                                </td>
                                            </tr>
                                        </tbody> <!-- Closing <tbody> for main table -->
                                    </table>
                                </div>
                            </td>
                        </tr>
                    </tbody> <!-- Closing <tbody> for body wrap -->
                </table>
            </BCol>
        </BRow>
    </Layout>
