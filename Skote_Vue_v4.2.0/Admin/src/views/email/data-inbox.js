import { avatar2, avatar3, avatar4, avatar6 } from "../../assets/images/users/data"
...
const sidepanelData = [
    {
        text: "Inbox",
        iconClass: "mdi mdi-email-outline me-2",
        active: true,
        count: 18
    },
    {
        text: "Starred",
        iconClass: "mdi mdi-star-outline me-2"
    },
    {
        text: "Important",
        iconClass: "mdi mdi-diamond-stone me-2"
    },
    {
        text: "Draft",
        iconClass: "mdi mdi-file-outline me-2"
    },
    {
        text: "Sent Mail",
        iconClass: "mdi mdi-email-check-outline me-2"
    },
    {
        text: "Trash",
        iconClass: "mdi mdi-trash-can-outline me-2"
    }
]
...
const labelData = [
    {
        text: "Theme Support",
        iconClass: "mdi mdi-arrow-right-drop-circle text-info float-end"
    },
    {
        text: "Freelance",
        iconClass: "mdi mdi-arrow-right-drop-circle text-warning float-end"
    },
    {
        text: "Social",
        iconClass: "mdi mdi-arrow-right-drop-circle text-primary float-end"
    },
    {
        text: "Friends",
        iconClass: "mdi mdi-arrow-right-drop-circle text-danger float-end"
    },
    {
        text: "Family",
        iconClass: "mdi mdi-arrow-right-drop-circle text-success float-end"
    }
]
...
export { emailData, sidepanelData, labelData, chatData };
