...
<template>
  <div class="hori-timeline">
    <carousel ref="carousel" class="events navs-carousel owl-carousel" id="timeline-carousel" :perPageCustom="[[480, 2], [768, 4]]" :navigation-enabled="false" :pagination-enabled="false">
      <slide>
