        ...
        <BCard no-body>
          <BCardBody>
            ...
            <h1 class="mb-3">
              ...
              <small class="text-muted">Semibold 2.125rem (32.5px)</small>
            </h1>
            <h2 class="mb-3">
            ...
            <h3 class="mb-3">
              ...
              <small class="text-muted">Semibold 1.42188rem (22.75px)</small>
            </h3>
            <h4 class="mb-3">
            ...
            <h5 class="mb-3">
              ...
              <small class="text-muted">Semibold 1.01563rem (16.25)</small>
            </h5>
            <h6 class="mb-0">
